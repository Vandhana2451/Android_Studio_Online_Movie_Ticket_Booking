...
public class seats extends AppCompatActivity {
    Button b;
    public static String seatid1=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(seats.this, movieName + "\n" + dateSlot1 + "\n" + timeSlot1 + "\n" + seatSlot1, Toast.LENGTH_LONG).show();
        ...
        reference.child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(seats.this, "Something went wrong", Toast.LENGTH_LONG).show();
    ...
    private void validation() {
        ...
        if (!chk1.isChecked() && !chk2.isChecked() && !chk3.isChecked() && !chk4.isChecked() && !chk5.isChecked() && !chk6.isChecked()
            ...
            Toast.makeText(seats.this, "you have to select the seats", Toast.LENGTH_LONG).show();
            return;
        ...
        seatid1=result.toString();
        total=total1.toString();

        if(checked!=seatSlot1) {
            Toast.makeText(seats.this, "you have to select correct no.of seats", Toast.LENGTH_LONG).show();
            return;


        }
       Intent intent = new Intent(seats.this, payment.class);
