...
public class date_time_3 extends AppCompatActivity {
    String[] date = { "03/11/2021(Wed)", "04/11/2021(Thu)", "05/11/2021(Fri)"};
    Button seat;
    RadioGroup rg,rg1;
    RadioButton rb1,rb2,rb3,rb4,rb5,rb6,rb7,rb8,rb9;
    public static String timeSlot3 = null;
    public static String dateSlot3 = null;
    public static int seatSlot3=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if (i == rb4.getId()) {
                    seatSlot3 = Integer.parseInt("1");
                } else if (i == rb5.getId()) {
                    seatSlot3 =  Integer.parseInt("2");
                } else if (i == rb6.getId()) {
                    seatSlot3 =  Integer.parseInt("3");
                } else if (i == rb7.getId()) {
                    seatSlot3 =  Integer.parseInt("4");
                } else if (i == rb8.getId()) {
                    seatSlot3 =  Integer.parseInt("5");
                } else if (i == rb9.getId()) {
                    seatSlot3 =  Integer.parseInt("6");
        ...
        seat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dateSlot3 = spin.getSelectedItem().toString();
                validation();
        ...
        reference.child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(date_time_3.this,"Something went wrong",Toast.LENGTH_LONG).show();
    ...
    private void validation() {
        ...
        if(isSelected==-1){
            Toast.makeText(date_time_3.this,"you have to select the time slot",Toast.LENGTH_LONG).show();
            return;
        }
        if(isSelected1==-1){
            Toast.makeText(date_time_3.this,"you have to select the no.of seat",Toast.LENGTH_LONG).show();
            return;
        }

        Intent intent = new Intent(date_time_3.this,
                seats_3.class);
