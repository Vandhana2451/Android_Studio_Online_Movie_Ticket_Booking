...
public class payment extends AppCompatActivity implements OnClickListener {
    ...
    private void button() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1=new Intent(payment.this,confirm.class);
                ...
                intent1.putExtra("Total",String.valueOf(total));
