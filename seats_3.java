...
import static com.example.project.date_time_3.seatSlot3;
...
public class seats_3 extends AppCompatActivity {
    private FirebaseUser user;
    private DatabaseReference reference;
    private String userid;
    public static String seatid3=null;
    public static String total3=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seats3);
        getSupportActionBar().hide();
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        Toast.makeText(seats_3.this, movieName + "\n" + dateSlot3 + "\n" + timeSlot3 + "\n" + seatSlot3, Toast.LENGTH_LONG).show();
        ...
        reference.child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(seats_3.this,"Something went wrong",Toast.LENGTH_LONG).show();
    ...
    private void validation() {
        ...
        {
            Toast.makeText(seats_3.this,"you have to select the seats",Toast.LENGTH_LONG).show();
            return;
        ...
        seatid3=result.toString();
        total3=total1.toString();

        if(checked!=seatSlot3) {
            Toast.makeText(seats_3.this, "you have to select correct no.of seats", Toast.LENGTH_LONG).show();
            return;
        }
        Intent intent = new Intent(seats_3.this, payment3.class);
        // intent.putExtra("seatId",String.valueOf(seatid1));

        intent.putExtra("Total3",String.valueOf(total3));
